...
public interface RaspberryClient {
    @PostMapping("/api/ports/{portId}/battery-switch")
    void requestPortBatterySwitching(@PathVariable("portId") String portId, @RequestBody BatterySwitchRequest batterySwitchRequest);
}
