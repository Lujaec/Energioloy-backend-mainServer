...
public class PowerController {
    ...
    public ResponseEntity<SuccessResponse<MonthlyPowerPredictionResponse>> getMonthlyPowerPrediction(@AdminAuthenticationPrincipal User user) {
    ...
    public ResponseEntity<SuccessResponse<DailyPowerUsageResponse>> getDailyPowerUsage(@AdminAuthenticationPrincipal User user) {
    ...
    public ResponseEntity<SuccessResponse<DailyPowerPredictionResponse>> getDailyPowerPrediction(@AdminAuthenticationPrincipal User user) {
